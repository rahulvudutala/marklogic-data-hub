...
function verifyFacetsInStepResponse() {
    const query = {
        ...
        "facets": {
            "stepName": {
                "dataType": "xs:string",
                "stringValues": ["mapping-step-json"]
            },
            "jobStatus": {
                "dataType": "xs:string",
                "stringValues": ["finished"]
            },
            "stepDefinitionType": {
                "dataType": "xs:string",
                "stringValues": ["mapping"]
            },
            "flowName": {
                "dataType": "xs:string",
                "stringValues": ["ingestion_mapping-flow"]
            },
            "startTime": {
                "dataType": "xs:string",
                "stringValues": ["2019-06-25T23:11:27.510711Z", "2019-06-27T23:11:27.510711Z"]
            }
        }
    };
    const response = jobQueryService.findStepResponses(query);
...
function verifyFacetsInStepResponseForNonExistentData() {
    let query = {
        ...
        "facets": {
            "startTime": {
                "dataType": "xs:string",
                "stringValues": ["2003-06-24T23:11:27.510711Z", "2004-06-25T23:11:27.510711Z"]
            }
        }
    };
    const response1 = jobQueryService.findStepResponses(query);
...
function verifyFacetsInStepResponseInDataWithSingleQuotes() {
    let query = {
        ...
        "facets": {
            "stepName": {
                "dataType": "xs:string",
                "stringValues": ["ingest-ste'p-jso'n"]
            }
        }
    };
    const response = jobQueryService.findStepResponses(query);
